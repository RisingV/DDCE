...
#include <jni.h>
/* Header for class com_bdcom_itester_lib_ITesterLibLoader */

#ifndef _Included_com_bdcom_itester_lib_ITesterLibLoader
#define _Included_com_bdcom_itester_lib_ITesterLibLoader
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_bdcom_itester_lib_ITesterLibLoader_loadDlls
  (JNIEnv *, jclass);

/*
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    connectToServer
 * Signature: (Ljava/lang/String;)Lcom/bdcom/itester/lib/CommuStatus;
 */
 ...
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    getCardInfo
 * Signature: (II)Lcom/bdcom/itester/lib/CardInfo;
 */
 ...
 * Signature: (III)Lcom/bdcom/itester/lib/EthPhyProper;
 */
 ...
 * Signature: (IIII[I)I
 */
JNIEXPORT jint JNICALL Java_com_bdcom_itester_lib_ITesterLibLoader_getPortAllStats
  (JNIEnv *, jobject, jint, jint, jint, jint, jintArray);

/*
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    getLinkStatus
 * Signature: (III)Lcom/bdcom/itester/lib/LinkStatus;
 */
 ...
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    getWorkInfo
 * Signature: (III)Lcom/bdcom/itester/lib/WorkInfo;
 */
 ...
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    getUsedState
 * Signature: (III)Lcom/bdcom/itester/lib/UsedState;
 */
 ...
 * Signature: (IIII)Lcom/bdcom/itester/lib/StreamInfo;
 */
 ...
 * Class:     com_bdcom_itester_lib_ITesterLibLoader
 * Method:    stopCapture
 * Signature: (III)Lcom/bdcom/itester/lib/CaptureResult;
 */
