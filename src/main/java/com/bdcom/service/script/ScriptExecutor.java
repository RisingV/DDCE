...
import com.bdcom.service.*;
import com.bdcom.util.log.ErrorLogger;
import com.bdcom.service.script.interpreter.DefaultInteractor;
import com.bdcom.service.script.interpreter.ScriptInteractor;
import com.bdcom.service.script.interpreter.ScriptInterpreter;
import com.bdcom.service.script.session.CrtSession;
...
//	}
	...
	public String getTesterNum() {
		return AppSession.getTestNum();
	}
	
	private void addToAppContent(final Set<String> set) {
        Application.addAttribute( CONTENT.SERIAL_NUM_SET, set );
	}

    private ScriptMgr getScriptMgr() {
        if ( null == scriptMgr ) {
            scriptMgr = (ScriptMgr)
                    Application.getAttribute( COMPONENT.SCRIPT_MGR );
        }
